...
public sealed partial class CustomProjectSetupViewModel : ViewModelBase
{
    ...
    private readonly Action<CustomInstallerProject, string, string> _openWorkspace;
    ...
    public CustomProjectSetupViewModel(IFileDialogService fileDialogService, AppStatusViewModel status,
        SettingsViewModel settings, Action<CustomInstallerProject, string, string> openWorkspace,
    ...
    private async Task BrowseProjectPathAsync()
    {
        ...
        ProjectPath = Path.GetExtension(path)
    ...
    private async Task CreateProjectAsync()
    {
        ...
        try
        {
            var project = new CustomInstallerProject
            {
            ...
            await _customInstallerProjectStore.SaveAsync(ProjectPath, project);
    ...
    {
        return IsCreateStep && !IsBusy && IsStepValid(3);
    }
